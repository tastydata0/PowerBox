...
class VirusTotal(object):
    def __init__(self):
        self.apikey = "e17037f5d0a000cfcc18a71a58351c5d164e3940d1c4db45791786e7f57d8aac"
    ...
    def send_files(self, filenames):
        ...
        for filename in filenames:
            ...
            webbrowser.open("https://www.virustotal.com/gui/file/{0}/detection".format(resmap["scan_id"].split("-")[0]))
